...
#-e "CORE_PEER_ADDRESS=peer0.org1.ict.com:7051" -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/crypto/peerOrganizations/org1.ict.com/users/Admin@org1.ict.com/msp"

# Create the channel
docker exec -e "CORE_PEER_ADDRESS=peer0.org3.ict.com:7051" -e "CORE_PEER_LOCALMSPID=Org3MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/crypto/peerOrganizations/org3.ict.com/users/Admin@org3.ict.com/msp" cli peer channel create -o orderer.ict.com:7050 -c channel1 -f /etc/hyperledger/configtx/channel1.tx
sleep 3
docker exec -e "CORE_PEER_ADDRESS=peer0.org3.ict.com:7051" -e "CORE_PEER_LOCALMSPID=Org3MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/crypto/peerOrganizations/org3.ict.com/users/Admin@org3.ict.com/msp" cli peer channel create -o orderer.ict.com:7050 -c channel2 -f /etc/hyperledger/configtx/channel2.tx
sleep 3

# Join peer0.org1.ict.com to the channel.
